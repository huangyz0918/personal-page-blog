...
![Java Memory Model Abstract Diagram](https://i.loli.net/2019/09/07/Zac3zRHBtiW7V9X.png)
...
![Communication Between Threads](https://i.loli.net/2019/09/07/rwiRIzky2l7WMPj.png)
...
![Instruction Reordering](https://i.loli.net/2019/09/07/jkEhnV9zsK73Lqe.png)
...
> **As-if-serial Semantics:** No matter how reordering is done (by compilers and processors to improve parallelism), the execution result of a (single-threaded) program cannot be changed.
...
![A Possible Execution Sequence](https://i.loli.net/2019/09/07/wS3NWBxsCe82r5n.png)
