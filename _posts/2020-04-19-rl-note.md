...
$$
(s_t, a_t) \rightarrow Network \left [ Q^{\pi} \right ] \rightarrow Q^{\pi}(s_t, a_t) \leftrightarrow r_t + Q^{\pi}(s_{t+1}, \pi(s_{t+1})) \leftarrow Network \left [ Q^{\pi} \right ] \leftarrow (s_{t+1}, \pi(s_{t+1}))
$$
