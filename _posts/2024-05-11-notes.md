...
[RAG](https://en.wikipedia.org/wiki/Retrieval-augmented_generation) enhances generation by introducing external knowledge, improving outcomes. A typical use case is a question-answering system that retrieves knowledge base entries for accurate answers.
