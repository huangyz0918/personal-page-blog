...
- A clear trend that is, deep learning models are getting larger and larger --which brings the challenge of the hardware design and the software optimization. The hardware design will be specialized for certain deep learning tasks (e.g., language models), and the software optimization should be fine-grained enough to provide insights.
