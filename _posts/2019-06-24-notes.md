...
---
layout: post
title: In-Depth Understanding of Java Thread Safety - Synchronized
categories: tech
...
We can easily answer this based on the dirty read example: __Yes__.
...
__No, the `synchronized` keyword is not inherited.__
